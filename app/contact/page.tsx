...
export const metadata = {
  ...
  description:
    'Contact Kesla Auto Pvt. Ltd. — exclusive Chufeng M31 dealer in Nepal. Located at Ward No. 6, Bouddha, Kathmandu.',
};
      ...
      <div className="container max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-center text-on-surface-variant font-body max-w-xl mx-auto">
            ...
            Visit us at our showroom in Bouddha, Kathmandu or reach out below.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-surface-container p-8 rounded-2xl border border-outline-variant/15 flex gap-4">
              ...
              <div>
                <h4 className="font-display font-bold text-white uppercase mb-1">Showroom &amp; Office</h4>
                <p className="text-on-surface-variant font-body">
                  Kesla Auto Pvt. Ltd.<br />
                  Ward No. 6, Bouddha<br />
                  Kathmandu, Nepal
                </p>
              </div>
            </div>
            ...
            <div className="bg-surface-container p-8 rounded-2xl border border-outline-variant/15 flex gap-4">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body">+977-1-4900000</p>
            ...
            <div className="bg-surface-container p-8 rounded-2xl border border-outline-variant/15 flex gap-4">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body">info@keslaauto.com.np</p>
            ...
            <div className="bg-surface-container p-8 rounded-2xl border border-outline-variant/15 flex gap-4">
              ...
              <div>
                <h4 className="font-display font-bold text-white uppercase mb-1">Business Hours</h4>
          ...
          <div className="bg-surface-container-low p-8 rounded-2xl border border-outline-variant/15">
            <h3 className="font-display font-bold text-white text-2xl mb-2">Send a Message</h3>
            ...
            <form className="flex flex-col gap-4">
              <input
                ...
                className="bg-surface-container-lowest border border-outline-variant/20 py-3 px-4 rounded text-white placeholder:text-on-surface-variant/50 focus:outline-none focus:border-primary"
              />
              <input
                id="contact-phone"
                type="tel"
