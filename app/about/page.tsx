    ...
    <div className="w-full min-h-screen bg-surface pt-32 pb-24">
      <div className="container max-w-4xl mx-auto">
        ...
        <div className="bg-surface-container-low p-8 md:p-12 rounded-2xl border border-outline-variant/15 flex flex-col gap-6 text-on-surface-variant font-body leading-relaxed text-lg mb-12">
          <p>
            <strong className="text-white">Kesla Auto Pvt. Ltd.</strong> is the exclusive authorized dealer for the
            <strong className="text-primary"> Chufeng M31 1.5-ton light truck pickup</strong> within the territory of Nepal.
            Our authorization has been granted by <strong className="text-white">Xizang Xima Auto Automotive Technology Co., Ltd.</strong>
          ...
          <p>
            Based at <strong className="text-white">Ward No. 6, Bouddha, Kathmandu, Nepal</strong>, we are committed to bringing
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10 flex gap-4">
            ...
            <div>
              <h3 className="text-white font-display font-bold text-lg mb-1 uppercase tracking-wide">Exclusive Authorization</h3>
          ...
          <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10 flex gap-4">
            ...
            <div>
              <h3 className="text-white font-display font-bold text-lg mb-1 uppercase tracking-wide">Authorization Period</h3>
              <p className="text-on-surface-variant text-sm">
                Valid from <strong className="text-white">April 1, 2026</strong> to <strong className="text-white">March 31, 2027</strong>.
          ...
          <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10 flex gap-4">
            ...
            <div>
              <h3 className="text-white font-display font-bold text-lg mb-1 uppercase tracking-wide">Our Location</h3>
              <p className="text-on-surface-variant text-sm">
                Ward No. 6, Bouddha, Kathmandu, Nepal
              </p>
            </div>
          </div>
          <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10 flex gap-4">
            ...
            <div>
              <h3 className="text-white font-display font-bold text-lg mb-1 uppercase tracking-wide">Manufacturer</h3>
              <p className="text-on-surface-variant text-sm">
        ...
        <div className="grid grid-cols-3 gap-6 mb-16 text-center">
          <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10">
            ...
            <p className="text-sm font-display uppercase tracking-widest text-white">Exclusive Chufeng Dealer in Nepal</p>
          </div>
          <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10">
            <h3 className="text-4xl font-display font-bold text-primary mb-2">1.5T</h3>
            <p className="text-sm font-display uppercase tracking-widest text-white">Chufeng M31 Payload Capacity</p>
          </div>
          <div className="bg-surface-container p-8 rounded-xl border border-outline-variant/10">
            <h3 className="text-4xl font-display font-bold text-primary mb-2">100%</h3>
            <p className="text-sm font-display uppercase tracking-widest text-white">Genuine Parts &amp; Service</p>
          </div>
        </div>
